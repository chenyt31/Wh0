...
class VITRA_Paligemma(nn.Module):
    ...
    def _init_act_model(self):
        ...
        action_head = DiffusionPolicy(
            ...
            future_action_window_size = max(self.future_action_window_size - 1, 0),
    ...
    def prepare_vlm_input_embeddings(
        ...
        **kwargs
        ...
        update_causal_mask = getattr(self.model, "_update_causal_mask", None)
        causal_mask = (
            update_causal_mask(attention_mask, None, None, cache_position, input_ids, inputs_embeds, False)
