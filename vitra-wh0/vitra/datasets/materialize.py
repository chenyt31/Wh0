...
def get_vla_dataset_and_collator(
    ...
    Args:
        ...
        statistics_path: Optional explicit statistics JSON path. When set, it overrides
            dataset-specific defaults such as g1_dataset/g1_dataset_angle_statistics.json.
