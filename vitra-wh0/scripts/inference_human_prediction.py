...
def main():
    ...
    try:
        ...
        # Match training materialization: action chunks contain fwd_pred_next_n - 1 future steps.
        chunk_size = max(configs.get('fwd_pred_next_n', 16) - 1, 1)
...
def _hand_reconstruction_worker(args_dict, task_queue, result_queue):
    ...
    """
    from libs.hand_recon import Config, HandReconstructor
